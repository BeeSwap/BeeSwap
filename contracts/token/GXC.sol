 ...
 * GXC Token
 */
contract GXC is ERC20, ERC20Detailed {
    ...
    // Modifiers
    modifier onlyGov() {
        require(msg.sender == governance, "GXC-Token: !governance");
        _;
    }

    constructor () public ERC20Detailed("GXC.finance", "GXC", 18, 21000000 * 10 ** 18) {
    ...
    function mint(address _account, uint256 _amount) public {
        require(minters[msg.sender], "GXC-Token: !minter");
    ...
    function acceptGov()
        external {
        require(msg.sender == pendingGov, "GXC-Token: !pending");
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal {
        ...
        if (from == address(0)) { // When minting tokens
            require(totalSupply().add(amount) <= cap(), "GXC-Token: Cap exceeded");
        }
    }
}